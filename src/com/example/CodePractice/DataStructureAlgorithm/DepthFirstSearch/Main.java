...
If reach a dead end, or an already visited node, backtrack to a previous node with unvisited adjacent neighbors
*/
public class Main {
    public static void main(String[] args) {
        ...
        //start the depth first search at src (Can change the number from 0~5 to decide which node to start with)
